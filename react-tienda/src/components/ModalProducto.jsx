...
export default function ModalProducto() {
  ...
  return (
    <main className={`${darkMode ? 'bg-gray-500 ' : 'bg-white'} p-3 max-h-screen overflow-y-auto`}>
    <div className="flex flex-col sm:flex-row items-center gap-10">
        ...
        <div className="w-full sm:w-2/3">
          ...
          <p className={`${darkMode ? 'text-black ' : 'text-gray-600 '}mt-2 pr-20`}>
            {producto.descripcion} {/* Aquí se agrega la descripción */}
          </p>
